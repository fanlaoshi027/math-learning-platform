...
class Hls_Converter {
    ...
    private function course_directory_name( $title ) {
        ...
        $fallback = array(
            '一元二次方程' => 'yiyuanercifangcheng', '一元一次方程' => 'yiyuanyicifangcheng',
            '二次函数' => 'ercihanshu', '一次函数' => 'yicihanshu', '三角形' => 'sanjiaoxing',
            '勾股定理' => 'gougu-dingli', '因式分解' => 'yinshifenjie', '大培优' => 'dapeiyou',
            '培优' => 'peiyou', '全等' => 'quandeng', '系统课' => 'xitongke', '专题' => 'zhuanti',
            '基础' => 'jichu', '提高' => 'tigao', '入门' => 'rumen', '数学' => 'shuxue',
        ...
        // 保证课程名称中的年份与主体分开：8shangdapeiyou2026 → 8shang-dapeiyou-2026。
        $title = preg_replace( '/^(\d+(?:shang|xia))([a-z]+)(\d{4})$/', '$1-$2-$3', $title );
