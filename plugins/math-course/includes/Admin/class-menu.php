...
class Menu {
    ...
    public function register_menu() {
        ...
        add_submenu_page('mathcourse', '学员管理', '学员管理', 'manage_options', 'mathcourse-students', array($this, 'students_page'));
    ...
    public function dashboard() {
        ...
        if ('POST' === ($_SERVER['REQUEST_METHOD'] ?? '') && isset($_POST['mathcourse_dashboard_action'])) {
            ...
            if ('grant_access' === $action && isset($_POST['mathcourse_dashboard_nonce']) && wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['mathcourse_dashboard_nonce'])), 'mathcourse_dashboard_grant')) {
                ...
                if (!$user) { $message = '未找到该学员账号，请先在“学员管理”中创建账号。'; $message_type = 'error'; }
    ...
    public function students_page(){if(class_exists('MathCourse\\Admin\\Student_Page'))(new Student_Page())->render();}
