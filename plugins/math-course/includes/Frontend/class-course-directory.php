...
class Course_Directory {
    ...
    public function render_learning_center() {
        ...
        $active_count=count($cards); $completed_total=0; $lesson_total=0;
        ...
        <div class="mathcourse-learning-center">
          <section class="mc-learning-hero">
            ...
            <div class="mc-learning-hero__stats"><span><b><?php echo esc_html($active_count); ?></b><small>已激活课程</small></span><span><b><?php echo esc_html($completed_total); ?></b><small>已学完课时</small></span><span><b>—</b><small>累计学时</small></span></div>
          </section>
