...
define('MATHCOURSE_VERSION','1.0.13'); define('MATHCOURSE_FILE',__FILE__); define('MATHCOURSE_DIR',plugin_dir_path(__FILE__)); define('MATHCOURSE_URL',plugin_dir_url(__FILE__));
...
add_action('init',function(){
    ...
    $rewrite_version='1.0.13'; if(get_option('_mathcourse_rewrite_version')!==$rewrite_version){flush_rewrite_rules(false);update_option('_mathcourse_rewrite_version',$rewrite_version,false);}
},99);
