...
extension GraphicObject {
    static func line(from start: CGPoint, to end: CGPoint, style: Style = Style()) -> GraphicObject {
        GraphicObject(
            kind: .line,
            style: style,
            geometry: Geometry(points: [start, end])
        )
    }

    static func polygon(points: [CGPoint], style: Style = Style()) -> GraphicObject {
        GraphicObject(
            kind: .polygon,
            style: style,
    ...
    static func rectangle(_ rect: CGRect, style: Style = Style()) -> GraphicObject {
        GraphicObject(
            kind: .rectangle,
            style: style,
    ...
    static func ellipse(_ rect: CGRect, style: Style = Style()) -> GraphicObject {
        GraphicObject(
            kind: .ellipse,
            style: style,
            geometry: Geometry(x: rect.minX, y: rect.minY, width: rect.width, height: rect.height)
