...
class Course_Directory_Assets {
    ...
    public function enqueue() {
        ...
        wp_enqueue_style('mathcourse-course-directory-responsive-fix', MATHCOURSE_URL . 'assets/course-directory-responsive-fix.css', array('mathcourse-course-directory-ui-polish'), MATHCOURSE_VERSION);
