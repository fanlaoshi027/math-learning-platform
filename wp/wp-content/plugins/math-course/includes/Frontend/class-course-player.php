...
class Course_Player {
    ...
    private function assets() {
        ...
        wp_enqueue_style('mathcourse-course-player-ui-polish', MATHCOURSE_URL . 'assets/course-player-ui-polish.css', array('mathcourse-course-player-ui-v2'), MATHCOURSE_VERSION);
        ...
        <div class="mc-course-player" data-course-id="<?php echo esc_attr($course_id); ?>">
            ...
            <div class="mc-course-player__layout">
                ...
                <div class="mc-course-player__completion" hidden aria-live="polite">
                    ...
                    <?php if($navigation['next']): ?><a class="mc-course-player__completion-next<?php echo empty($navigation['next']['accessible'])?' is-locked':''; ?>" href="<?php echo esc_url($navigation['next']['url']); ?>"<?php echo empty($navigation['next']['accessible'])?' data-mathcourse-lock="1"':''; ?>>下一课：<?php echo esc_html($navigation['next']['title']); ?><span>→</span></a><?php else: ?><a class="mc-course-player__completion-next" href="<?php echo esc_url($base); ?>">返回课程<span>→</span></a><?php endif; ?>
                </div>
