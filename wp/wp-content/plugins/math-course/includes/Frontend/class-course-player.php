...
class Course_Player {
    ...
    public function render($atts=array()) {
        ...
        <div class="mc-course-player" data-course-id="<?php echo esc_attr($course_id); ?>">
            ...
            <div class="mc-course-player__layout">
                ...
                <div class="mc-course-player__completion" hidden aria-live="polite"><div><strong>✓ 本课已完成</strong><span class="mc-course-player__completion-text">学习进度已更新</span></div><?php if($navigation['next']): ?><a class="mc-course-player__completion-next" href="<?php echo esc_url($navigation['next']['url']); ?>">下一课：<?php echo esc_html($navigation['next']['title']); ?><span>→</span></a><?php else: ?><a class="mc-course-player__completion-next" href="<?php echo esc_url($base); ?>">返回课程<span>→</span></a><?php endif; ?></div>
    ...
    private function lesson_navigation($data,$current,$course_id){
        ...
        $base=$this->learning_base_url(); $course_id=absint($course_id);
