...
class Plugin {
    ...
    private function load_assets() {
        add_action('wp_enqueue_scripts', function() {
            ...
            wp_enqueue_style('mathcourse-demo-player', MATHCOURSE_URL.'assets/css/demo-player.css', array('mathcourse'), MATHCOURSE_VERSION);
            wp_enqueue_script('mathcourse-player', MATHCOURSE_URL.'assets/js/player.js', array('jquery'), MATHCOURSE_VERSION, true);
            wp_localize_script('mathcourse-player','MathCourseData',array('ajaxurl'=>admin_url('admin-ajax.php')));
        });
    }
