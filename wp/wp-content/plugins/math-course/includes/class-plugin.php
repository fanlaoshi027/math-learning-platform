...
class Plugin {
    ...
    private function load_modules() {
        ...
        if (class_exists('MathCourse\\Access\\Activation_Schema')) new Access\Activation_Schema();
        if (class_exists('MathCourse\\Access\\Activation_Service')) new Access\Activation_Service();
        ...
        if (class_exists('MathCourse\\Admin\\Activation_Page')) new Admin\Activation_Page();
        ...
        if (class_exists('MathCourse\\Frontend\\Activation')) new Frontend\Activation();
    ...
    private function load_assets() { add_action('wp_enqueue_scripts', function() { wp_enqueue_style('mathcourse', MATHCOURSE_URL.'assets/css/mathcourse.css', array(), MATHCOURSE_VERSION); }); }
    private function load_admin_assets() { add_action('admin_enqueue_scripts', function() { wp_enqueue_style('mathcourse-admin', MATHCOURSE_URL.'assets/css/admin.css', array(), MATHCOURSE_VERSION); wp_enqueue_style('mathcourse-admin-redesign', MATHCOURSE_URL.'assets/css/admin-redesign.css', array('mathcourse-admin'), MATHCOURSE_VERSION); wp_enqueue_script('mathcourse-admin-course-editor', MATHCOURSE_URL.'assets/js/admin-course-editor.js', array(), MATHCOURSE_VERSION, true); }); }
}
