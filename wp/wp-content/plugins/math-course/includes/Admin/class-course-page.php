		...
		<div class="wrap">
			...
			<div style="background:#fff;border:1px solid #dcdcde;border-radius:10px;overflow:hidden;">
				<table class="wp-list-table widefat fixed striped">
					<thead><tr><th style="width:80px;">封面</th><th>课程</th><th>类型</th><th>年级</th><th>状态</th><th>时间</th><th>操作</th></tr></thead>
					<tbody>
					<?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
						...
						<tr>
							...
							<td><a class="button button-small" href="<?php echo esc_url( $editor_url ); ?>">编辑课程</a> <a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=mathcourse-courses&action=trash&course_id=' . $course_id ), 'mathcourse_trash_course_' . $course_id ) ); ?>">移至回收站</a></td>
						</tr>
					<?php endwhile; else : ?><tr><td colspan="7" style="padding:32px;text-align:center;">还没有课程。点击右上角“新建课程”开始。</td></tr><?php endif; ?>
					</tbody>
				</table>
			</div>
		</div>
