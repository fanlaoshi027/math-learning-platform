...
class Menu {
    ...
    public function register_menu() {
        ...
        add_submenu_page('mathcourse', '学习进度', '学习进度', 'manage_options', 'mathcourse-progress', 'manage_options', 'mathcourse-progress', array($this, 'progress_page'));
        add_submenu_page('mathcourse', '设置', '系统设置', 'manage_options', 'mathcourse-settings', 'manage_options', 'mathcourse-settings', array($this, 'settings_page'));
