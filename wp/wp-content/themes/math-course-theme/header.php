...
<header class="mc-site-header">
    <div class="mc-container mc-site-header__inner">
        <a class="mc-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="樊老师数学课堂首页">
            <span class="mc-brand__text">樊老师<span>数学课堂</span></span>
        </a>
        ...
        <form class="mc-header-search" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            <input type="search" name="s" value="<?php echo esc_attr( get_search_query() ); ?>" placeholder="搜索数学知识点" aria-label="搜索数学知识点">
            <button type="submit">搜索</button>
        </form>

        <div class="mc-header-actions">
            <?php if ( is_user_logged_in() ) : ?>
                <a class="mc-user-pill" href="<?php echo esc_url( home_url( '/learning-center/' ) ); ?>">我的学习 <span class="mc-user-pill__arrow" aria-hidden="true">→</span></a>
            <?php else : ?>
