...
<link rel="stylesheet" id="mc-home-reference-adjustments" href="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/home-reference-adjustments.css?ver=' . rawurlencode((string) filemtime(get_stylesheet_directory() . '/assets/home-reference-adjustments.css'))); ?>">
<?php
...
<main class="mc-home-v3">
    ...
    <section class="mc-home-v3__section mc-home-v3__types">
        ...
        <div class="mc-home-v3__type-grid"><a class="mc-home-v3__type-card mc-home-v3__type-card--system" href="<?php echo esc_url($system_url); ?>"><div class="mc-home-v3__book-stack" aria-hidden="true"><i></i><i></i><i></i><b></b></div><div class="mc-home-v3__type-copy"><h3>系统课</h3><p>构建完整的知识体系</p><p>从基础到提升，系统掌握初中数学</p><span>进入系统课 →</span></div></a><a class="mc-home-v3__type-card mc-home-v3__type-card--supplementary" href="<?php echo esc_url($supplementary_url); ?>"><div class="mc-home-v3__open-book" aria-hidden="true"><i></i><b></b><em></em></div><div class="mc-home-v3__type-copy"><h3>教辅配套课</h3><p>紧扣教材与教辅</p><p>逐题精讲，吃透每一道题</p><span>进入配套课 →</span></div></a></div>
    </section>
