...
<main class="mc-home-v3">
    <header class="mc-home-v3__header">
        <div class="mc-home-v3__header-inner">
            ...
            <nav class="mc-home-v3__nav" aria-label="主导航">
                ...
                <?php if (is_user_logged_in()) : ?><a href="<?php echo esc_url($learning_url); ?>">学习中心</a><?php endif; ?>
            </nav>
    ...
    <section class="mc-home-v3__hero" aria-label="樊老师数学">
        ...
        <div class="mc-home-v3__hero-inner"><div class="mc-home-v3__hero-copy"><h1><span>让更多学生</span><strong><em>爱上数学，</em>学好数学</strong></h1><p>系统的课程 · 清晰的讲解 · 实用的方法</p><a class="mc-home-v3__hero-button" href="<?php echo esc_url($course_center_url); ?>">浏览课程 <b>→</b></a></div></div>
    </section>
    <section class="mc-home-v3__section mc-home-v3__types">
        <div class="mc-home-v3__section-heading"><div><span class="accent"></span><h2>两大课程体系 · 满足不同学习需求</h2></div><a href="<?php echo esc_url($course_center_url); ?>">了解更多 →</a></div>
        <div class="mc-home-v3__type-grid">
            <a class="mc-home-v3__type-card mc-home-v3__type-card--system" href="<?php echo esc_url($system_url); ?>"><div class="mc-home-v3__book-stack" aria-hidden="true"><i></i><i></i><i></i><b></b></div><div class="mc-home-v3__type-copy"><h3>系统课</h3><p>构建完整的知识体系</p><p>从基础到提升，系统掌握初中数学</p><span>进入系统课 →</span></div></a>
            <a class="mc-home-v3__type-card mc-home-v3__type-card--supplementary" href="<?php echo esc_url($supplementary_url); ?>"><div class="mc-home-v3__open-book" aria-hidden="true"><i></i><b></b><em></em></div><div class="mc-home-v3__type-copy"><h3>教辅配套课</h3><p>紧扣教材与教辅</p><p>逐题精讲，吃透每一道题</p><span>进入配套课 →</span></div></a>
        </div>
    </section>
    <section class="mc-home-v3__section mc-home-v3__popular">
        ...
        <div class="mc-home-v3__course-grid">
            <?php if ($courses) : foreach ($courses as $index => $course) : $course_url=add_query_arg('course_id',$course->ID,home_url('/learning/')); $title=get_the_title($course->ID); $grade=(string)get_post_meta($course->ID,'_mathcourse_grade',true); if(!$grade){$grade='8';} $cover_classes='mc-home-v3__course-cover mc-home-v3__course-cover--'.($index+1); ?>
                <article class="mc-home-v3__course-card"><a class="<?php echo esc_attr($cover_classes); ?>" href="<?php echo esc_url($course_url); ?>"><span class="mc-home-v3__cover-copy"><b><?php echo esc_html($title); ?></b><small><?php echo esc_html('八年级' === $grade || '8' === $grade ? '八年级上册' : '初中数学系统课'); ?></small><em><?php echo esc_html($index===0?'热门推荐':'系统精讲'); ?></em></span></a><div class="mc-home-v3__course-body"><h3><?php echo esc_html($title); ?></h3><div class="mc-home-v3__tags"><span><?php echo esc_html('8'===$grade?'八年级':('9'===$grade?'九年级':'初中')); ?></span><span>视频精讲</span></div><a class="mc-home-v3__course-button" href="<?php echo esc_url($course_url); ?>">查看课程</a></div></article>
